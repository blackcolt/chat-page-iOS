...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_framework "${BUILT_PRODUCTS_DIR}/ChatViewController/ChatViewController.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/PlaceholderUITextView/PlaceholderUITextView.framework"
